...
;=============================================================================================
		;高亮控件设置
		Gui, 2:Destroy
		Gui, 2:-Caption +E0x80000 AlwaysOnTop ToolWindow +HwndGui2
		...
		fatPen:=Gdip_CreatePen(0xFFED1508, 2)
		Gdip_DrawRectangle(G, FatPen,WinX+OutCtrlX,WinY+OutCtrlY,OutCtrlW,OutCtrlH) ;WinX,WinY
		UpdateLayeredWindow(Gui2, hdc, 0, 0, A_ScreenWidth,A_ScreenHeight)
		EmptyMem()
;=============================================================================================
		Loop,%ListView2_Text_A0% 	
